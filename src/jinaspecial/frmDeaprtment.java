 ...
 * @author Vaibhav
 */
public class frmDeaprtment extends javax.swing.JFrame {

     dbConn mc=new dbConn();
     Connection con;
 DefaultTableModel model=new DefaultTableModel();
    /** Creates new form frmDeaprtment */
    public frmDeaprtment() {
        initComponents();
    }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        try{
            ...
            ResultSet rs=st.executeQuery("select department from tbldepartment where department='"+txtDepartment.getText()+"'");
            if(rs.next()){
                JOptionPane.showMessageDialog(rootPane, "Department is allready Exists");
            }
            else{            
             ...
             if (txtDepartment.getText().trim().length()==0 )
            {
               ...
               if (!matcher.matches()) {
                    JOptionPane.showMessageDialog(rootPane,"Please Enter Correct Department Name");
                      txtDepartment.setText("");
                      txtDepartment.setFocusable(true);
                }
             else{
               int i=st.executeUpdate("insert into tbldepartment values(null,'"+txtDepartment.getText()+"')");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        Statement st=con.createStatement();
         ...
         ResultSet rss=st.executeQuery("select max(id)+1 from tblDepartment");
        while(rss.next())
        {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
       try{
          ...
          int i=st.executeUpdate("update tblDepartment set department='"+txtDepartment.getText()+"' where id="+txtDeptID.getText()+"");
          if(i>0){
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try{
           Connection con=DriverManager.getConnection(mc.StrUrl,mc.StrUid,mc.StrPwd);
           Statement st=con.createStatement();
           int i=st.executeUpdate("Delete from tbldepartment where id="+txtDeptID.getText()+"");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new frmDeaprtment().setVisible(true);
            }
        });
    }
